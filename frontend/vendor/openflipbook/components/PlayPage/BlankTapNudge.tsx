...
export function BlankTapNudge({ nudgeKey, xPx, yPx, text = '这里还没有可进入的画页' }: Props) {
  return (
    <span
      key={nudgeKey}
      aria-hidden
      className="sw-openflipbook-blank-nudge pointer-events-none absolute -translate-x-1/2 -translate-y-full whitespace-nowrap rounded-full px-2.5 py-1 text-xs font-medium shadow-lg backdrop-blur"
