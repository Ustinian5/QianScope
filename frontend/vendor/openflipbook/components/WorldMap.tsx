...
import type { SceneView } from "../config/world";
...
export default function WorldMap({
  ...
  useEffect(() => {
    ...
    // Upstream camera initialization intentionally happens after ResizeObserver
    // provides the real viewport; this is the one synchronization write.
