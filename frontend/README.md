...
默认入口是全屏社会世界，不是传统仪表盘：用户可在贵阳真实底图上进入 7 个代表性场所和建筑，继续下钻三维空间，检索 5,000 个稳定合成人格，查看档案、关系和日程，并通过统一任务界面运行问卷、事件及九类洞察工具。
...
- 城市、场所、建筑和人物保持空间连续性；城市镜头会在 L1 → L2 → L1 下钻和返回时保留，移动端提供独立地点快捷导航。
